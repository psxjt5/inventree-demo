...
function demoPanel({
    ...
    return (
        ...
        {editPartForm.modal}
        <Stack gap="xs">
        <Title c={context.theme.primaryColor}  order={3}>demo</Title>
        <Text>
            This is a custom panel for the demo plugin.
        </Text>
        <SimpleGrid cols={2}>
...
export function renderdemoPanel(context: InvenTreePluginContext) {
